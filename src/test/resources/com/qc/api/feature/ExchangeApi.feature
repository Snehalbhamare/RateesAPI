@HSBC
Feature: To verify RatesApi exchange rate
...
Scenario Outline: To validate status code for foreign currency exchange rates api
	...
	Examples:
		...
		|1.with latest api |http://api.ratesapi.io/ 	|api/latest		|	200		  |
		|2.with date api	 |http://api.ratesapi.io/   |api/2010-01-12	|	200		  |
		#|3.with date api	 |https://api.ratesapi.io/   |api/			|	400		  |
